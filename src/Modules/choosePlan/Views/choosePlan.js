                            ...
                            <div className="mx-auto max-w-xs px-0 flex flex-col">
                                <div className="flex justify-center items-center lg:w-full">
                                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M23.8333 14.6667L15.5 24.6667H23L22.1667 31.3333L30.5 21.3333H23L23.8333 14.6667Z" stroke="#FF2413" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        <rect x="3" y="3" width="40" height="40" rx="20" stroke="#FFF6F6" stroke-width="6" />
                                    </svg>
                                </div>
                        ...
                        <div className="rounded-2xl bg-white sm:px-5 py-10 text-center ring-1 ring-inset ring-gray-200 shadow-md lg:flex lg:flex-col lg:justify-center lg:py-10">
                            <div className="mx-auto max-w-xs px-0 flex flex-col">
                                <div className="flex justify-center items-center lg:w-full">
                                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="3" y="3" width="40" height="40" rx="20" fill="#FFEAE9" />
                                        <path d="M14.6667 25.0833L23.0001 29.25L31.3334 25.0833M23.0001 16.75L14.6667 20.9167L23.0001 25.0833L31.3334 20.9167L23.0001 16.75Z" stroke="#FF2413" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        <rect x="3" y="3" width="40" height="40" rx="20" stroke="#FFF6F6" stroke-width="6" />
                                    </svg>
                                </div>
                        ...
                        <div className="rounded-2xl bg-white sm:px-5 py-10 text-center ring-1 ring-inset ring-gray-200 shadow-md lg:flex lg:flex-col lg:justify-center lg:py-10">
                            <div className="mx-auto max-w-xs px-0 flex flex-col">
                                <div className="flex justify-center items-center lg:w-full">
                                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="3" y="3" width="40" height="40" rx="20" fill="#FFEAE9" />
                                        <g clip-path="url(#clip0_171_34259)">
                                            <path d="M14.6667 27.1667L23.0001 31.3333L31.3334 27.1667M14.6667 23L23.0001 27.1667L31.3334 23M23.0001 14.6667L14.6667 18.8333L23.0001 23L31.3334 18.8333L23.0001 14.6667Z" stroke="#FF2413" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                        <rect x="3" y="3" width="40" height="40" rx="20" stroke="#FFF6F6" stroke-width="6" />
                                        <defs>
