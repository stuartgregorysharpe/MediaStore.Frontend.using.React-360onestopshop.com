...
const Sidebar = () => {
    ...
    return (
        <div ref={sidebarRef} className={`max-h-full bg-purple-950 text-white space-y-6 py-7 absolute inset-y-0 left-0 transform transition-all duration-200 ease-in-out overflow-x-hidden h-screen z-50 ${isOpen ? 'translate-x-0 w-64' : 'translate-x-0 w-16'}`}>
