...
import { searchAlphabeta, searchPopularity, searchRecent, searchVolume } from './FilteringAction';
    ...
    <div className='bg-violet-900'>
      ...
      /> */}
        ...
        <div className='flex justify-center items-center mt-10'>
          <p className='text-blue-400 text-3xl font-bold ml-3'>Filtered like below</p>
        </div>
