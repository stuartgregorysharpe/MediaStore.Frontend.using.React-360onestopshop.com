...
const stats = [
  { name: 'Total assets', value: '125+' },
  { name: 'Total downloads', value: '300+' },
  { name: 'Today views', value: '400+' },
  { name: 'Today downloads', value: '500+' },
]
...
const View = () => {
  ...
  const slides = [
    {
      title: "Your Hub for Entertainment and Artistry",
      messages: [
        "Sound Waves Await - Dive into Our Audio Spectrum",
        "Visual Delight - Browse Through Our Rich Video Tapestry",
      ]
    },
    {
      title: "Your Gateway to a World of Music and Video",
      messages: [
        "Journey with Us - The Making of Our Digital Media Empire",
        "Discover Our Story and the Passion behind Our Media Platform",
      ]
    }
  ];
    ...
    <div className='bg-violet-900'>
      ...
      /> */}
        ...
        <div className='flex justify-center items-center mt-10'>
          <p className='text-blue-400 text-3xl font-bold ml-3'>Immerse yourself in our Extensive Media Library for all 360 days</p>
        </div>
        ...
        <div className='md:p-40 md:pl-20 md:pt-0 md:grid grid-cols-4'>
          <div className='md:col mr-5 mt-6 mr-0'>
            ...
            <div className='flex justify-center itmes-center mt-5'>
              <p className='text-gray-300 font-bold text-3xl'>Past Achieves</p>
            </div>
            <div className='p-10 pt-0 mt-3 rounded-md'>
              <div className='flex justify-center itmes-center'>
                <button className='text-blue-400 font-bold text-2xl border border-blue-900 rounded-full p-10 pt-0 pb-1 mt-5 hover:border-gray-300 hover:text-red-200'>
